\dictum[G. W.F. Hegel]{In [dialectical] movement, consciousness
experiences the emergence of individuality in the unchangeable, and of
the unchangeable in individuality.}
...
denoted in the figure as \(\sigma_{p \land r}(\li)\). Our total size
budget is 2.5.
...
Then we need \(\sigma_{p}(\li)\) but we are now using 2 units of space
...
our next step, i.e., creating \(\sigma_{q}(\li)\) . \(\sigma_{\neg
