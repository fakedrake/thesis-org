...
\todo{Maybe remove this paragrah}
...
on the input of operations that can't be information preserving,
...
is translated to a forest if possible join orderings. These are
...
\item Projection sharing is determined. As we will see in detail in 
    ...
    the implementation details of the projection algorithm ant its reverse,
