...
In this chapter, we introduce the concept of reversible relational
operations. We go into detail about how a traditional AND/OR query
DAG augmented with reversible relational operators can facilitate a
new approach workload optimization focusing on memory efficiency and
throughput.
