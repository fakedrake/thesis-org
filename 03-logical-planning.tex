...
over a NULL value always evaluates to \hask{False}. Further we assume
...
\begin{itemize}
\item seqnence (the monadic bind) \hask{(>>=) : p a -> (a -> p b) -> p
...
\item Date intervals are translated to dates. This is because the
  ...
  expression like \sql{date '2020-12-01' + shipping\_time} is not
