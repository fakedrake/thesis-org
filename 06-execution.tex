...
implementation of in-place sorting hinges on the \cpp{RecordMap} type that
...
to \cpp{std::sort} (see listing \ref{lst:record_map_sort}) which runs insertion
...
Here the symbols \hask{a}, \hask{x}, and possibly even \hask{f} would
...
The obvious problem with this approach however changes the meaning of
