...
The \hask{HCntT} needs to be \emph{dissolved} to run the actual
...
set of a non-deletable n-node that takes up less size that the n-node
...
render the n-node deletable. For example the \(\theta\)-join n-node \(A
