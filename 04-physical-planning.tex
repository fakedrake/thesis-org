...
literature support both we developed the \hask{HCntT} backtracking monad
...
listing \ref{lst:monad_logic} the MonadLogic able to \hask{cons} (dubbed \hask{reflect})
and \hask{uncons} (dubbed \hask{msplit}).
...
priority. The value passed to \hask{halt} must implement a
